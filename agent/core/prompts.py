...
def _format_reminder() -> str:
    ...
    return (
        ...
        "   Nội dung ở trang nào thì ghi trang đó, không mặc định ghi trang đang mở. "
        "Câu trả lời phải có ít nhất một tag `[Trang N]` — trừ đúng một trường hợp ở mục 3.\n\n"
        "3. Bài giảng không đủ để trả lời? → gọi `search_web` NGAY, đừng bảo học viên tự tra. "
        "Sau khi có kết quả, "
